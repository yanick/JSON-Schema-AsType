...
=method add_vocabulary($vocabulary_role) 
...
L<JSON::Schema::AsType> passes all the non-optional JSON schema test suites 
...
As for the optional test suites, I didn't try to run them yet. Stay tuned. :-)
